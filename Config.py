...
class Config:
    ...
    def create_instance() -> dict[str, any]:
        ...
        parser.add_argument('--k', type=int, default=6000, help='Value for k')
        parser.add_argument('--epsilon', type=float, default=0.0005, help='Value for epsilon')
        parser.add_argument('--population_size', type=int, default=20000, help='Population size')
        parser.add_argument('--generations', type=int, default=40, help='Number of generations')
        parser.add_argument('--search_spread', type=int, default=10, help='Search spread')
        parser.add_argument('--epochs', type=int, default=100, help='Number of epochs')
        parser.add_argument('--dont_get_from_disk', action='store_false', help='Flag to not read data from the disk')
        parser.add_argument('--num_of_classes', type=int, default=10, help='Number of classes')
        ...
        parser.add_argument('--delete_checkpoints', action='store_false', help='Flag to delete checkpoints')
        parser.add_argument('--genetic_alg_prediction_max_batch_size', type=int, default=100,
                            help='Max batch size for genetic algorithm prediction')
        parser.add_argument('--data_directory', type=str, default='/ssd/SaveDataset/Batches', help='Data directory')
        parser.add_argument('--destination_folder', type=str,
                            default='{data_directory}/{model_class}/{generations}_generations',
                            help='Destination folder')
        parser.add_argument('--file_path_confidence_batch', type=str,
    ...
    @staticmethod
    def configure_logging(log_file: str = "model_log.log", log_level: str = "INFO") -> logging.Logger:
        """
