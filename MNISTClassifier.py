...
class MNISTClassifier(nn.Module):
    ...
    #         model = nn.DataParallel(self, device_ids=gpu_list)
    ...
    def generate_random_data(num, tile_size=5, num_tiles=50):
        ...
        # data = generate_tiles_to_data(data, num, tile_size, num_tiles, image_size)
        return data
        # return [torch.rand(1, 1, 28, 28).cpu() for _ in range(num)]
        # image_list = []
        # for i in range(num):
